variable "architecture" {
  description = "The CPU architecture you want your AMI to use. Set this to x86_64 or arm64"
  type        = string
  # maybe set version and arch as variables to make this more dynamic?
  default     = "x86_64"
}
...
variable "ami_type" {
  description = "The type of AMI to create. Valid values are `amazon-linux-2023` or `amazon-linux-2023-arm64`"
  type        = string
...
variable "ami_description" {
  ...
  type        = string
  default     = "Amazon EKS Kubernetes AMI based on AmazonLinux2023 OS"
}
